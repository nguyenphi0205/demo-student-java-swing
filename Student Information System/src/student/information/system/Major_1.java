 ...
 * @author nguyenphi
 */
public class Major_1 extends javax.swing.JFrame {
 ...
 java.util.Date date = new java.util.Date();
  ...
  public void currentDate() {
    ...
    private void initComponents() {
        ...
        txt_majorID = new javax.swing.JTextField();
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txt_majorID, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    ...
                                    .addComponent(jLabel4)
                                    .addComponent(txt_majorID, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
  ...
  int p = JOptionPane.showConfirmDialog(null, "Are you sure you want to add record?", "Add Record", JOptionPane.YES_NO_OPTION);
        if (p == 0) {
            ...
            if (txt_majorname.getText().equals("")) {
                JOptionPane.showMessageDialog(this, "major name not null !");
                txt_majorname.requestFocus();
                return;
            }
            if (txt_majorname.getText().length() > 30) {
                JOptionPane.showMessageDialog(this, "major must < 30 characters !");
...
// TODO add your handling code here:
  ...
  int row = this.Major_table.getSelectedRow();
        txt_majorID.setText((String) (Major_table.getValueAt(row, 0)).toString());
...
//txt_surname.setText((String) (student_table.getValueAt(row, 5)));
   ...
   int p = JOptionPane.showConfirmDialog(null, "Are you sure you want to delete record?", "Delete", JOptionPane.YES_NO_OPTION);
        if (p == 0) {
            ...
            try {
                pst = conn.prepareStatement(sql);
                pst.setString(1, txt_majorID.getText());
                pst.execute();
 ...
 int p = JOptionPane.showConfirmDialog(null, "Are you sure you want to update?", "Update Record", JOptionPane.YES_NO_OPTION);
        if (p == 0) {
            ...
            try {
                ...
                String value1 = txt_majorID.getText();
...
//                        + "Exam='"+value10+"',Post_code ='"+value11+"''"where id='"+value4+"'";
                String sql = "update  Major set  major_name='"+value2+"' ,End_day='"+value3+"' ,Start_day='"+value4+"' ,Lecturer_name='"+value5+"',Student_ID='"+value6+"'  WHERE major_Id='"+value1+"'";
                pst = conn.prepareStatement(sql);
                pst.execute();
...
// TODO add your handling code here:
 ...
 try {
            String sql = "Select * from Major where major_name like ? ";
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Major_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField txt_majorID;
